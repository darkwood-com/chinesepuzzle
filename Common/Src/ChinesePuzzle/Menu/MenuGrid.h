...
class CC_DLL MenuGridSwipeTo : public cocos2d::CCActionInterval
{
public:
...
public:
	/** creates the action */
	static MenuGridSwipeTo* actionWithDuration(cocos2d::ccTime duration, const cocos2d::CGFloat& swipe);
...
class CC_DLL MenuGridDelegate
{
public:
	/** Called when scroll layer begins scrolling.
	 * Usefull to cancel CCTouchDispatcher standardDelegates.
	 */
	virtual void scrollLayerScrollingStarted(MenuGrid* sender) {}
	
	/** Called at the end of moveToPage:
	 * Doesn't get called in selectPage:
	 */
	virtual void scrollLayerScrolledToPageNumber(MenuGrid* sender, int page) {}
};

class CC_DLL MenuGrid : public cocos2d::CCNode, public cocos2d::CCTouchDelegate
{
protected:
	//display
...
public:
	...
	CC_SYNTHESIZE(MenuGridDelegate*, m_pDelegate, Delegate)
